...
<div class="wrongpage">You are not on the correct page.<br>To use Ace click the button below to redirect and run the bookmarklet again.<div class="item-left-buttons" style="justify-content: center; margin: 20px;">
<iframe id="innerFrame" name="innerFrame" sandbox="allow-scripts allow-popups allow-forms allow-same-origin allow-popups-to-escape-sandbox allow-downloads" frameborder="0" allowfullscreen="" src="https://ggdisable2.brendandenzel.repl.co/" style="overflow: auto;">
</iframe>
